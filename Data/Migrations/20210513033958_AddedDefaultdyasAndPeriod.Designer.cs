...
namespace leave_mgmnt.Data.Migrations
{
    ...
    [Migration("20210513033958_AddedDefaultdyasAndPeriod")]
    partial class AddedDefaultdyasAndPeriod
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("leave_mgmnt.Data.LeaveAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("leave_mgmnt.Data.LeaveHistorys", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("leave_mgmnt.Data.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("leave_mgmnt.Data.LeaveAllocation", b =>
                {
                    b.HasOne("leave_mgmnt.Data.Employee", "employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("leave_mgmnt.Data.LeaveType", "leaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("leave_mgmnt.Data.LeaveHistorys", b =>
                {
                    ...
                    b.HasOne("leave_mgmnt.Data.Employee", "approvedBy")
                        .WithMany()
